/*
    ...
    Description: This script is used to manage the game state for the Fact vs Opinion game by checking the player's answer and updating the score accordingly. It also handles moving to the next question and ending the game when all questions have been answered.
*/
using UnityEngine;
